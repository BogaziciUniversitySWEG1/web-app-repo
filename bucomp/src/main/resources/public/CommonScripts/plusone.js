...
(function() {
    ...
    var D = function(a, b, c) {
        ...
        ra = function(a) {
            return a.K + (0 < a.l.length ? "?" + a.l.join("&") : "") + (0 < a.v.length ? "#" + a.v.join("&") : "")
        },
        sa = function(a, b) {
            var c = [];
            if (a)
        ...
        ta = function(a, b, c, d) {
            a = qa(a);
            a.l.push.apply(a.l, sa(b, d));
            a.v.push.apply(a.v, sa(c, d));
            return ra(a)
        },
        ua = function(a, b) {
            var c = "";
    ...
    var La = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Va = function(a, b, c, d) {
            ...
            return [encodeURIComponent(a.$).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.J ? "/am=" + e(a.J) : "", a.T ? "/rs=" + e(a.T) : "", a.V ? "/t=" + e(a.V) : "", "/cb=", e(c)].join("")
        },
        Ta = function(a) {
    ...
    var V = function() {
        ...
        this.w = [];
        this.w[0] = 128;
        for (var a = 1; a < this.c; ++a) this.w[a] = 0;
        this.A = this.j = 0;
        this.reset()
    };
    (function() {
    ...
    V.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.c, d = 0, e = this.C, f = this.j; d < b;) {
                if (0 == f)
    ...
    V.prototype.digest = function() {
        var a = [],
            b = 8 * this.A;
        56 > this.j ? this.update(this.w, 56 - this.j) : this.update(this.w, this.c - (this.j - 56));
        for (var c = this.c - 1; 56 <= c; c--) this.C[c] = b & 255, b /= 256;
        Ab(this, this.C);
        for (c = b = 0; 5 > c; c++)
                ...
                case 1:
                    ...
                    if (b.parentNode) {
                        ...
                        if ((h || {}).allowPost && 2E3 < f.length) {
                            ...
                            m = (h = l.l[0]) ? h.split("&") : [];
                            h = [];
                            for (q = 0; q < m.length; q++) t = m[q].split("=", 2),
                                h.push([decodeURIComponent(t[0]), decodeURIComponent(t[1])]);
                            l.l = [];
                            m = ra(l);
    ...
    Rc.prototype.write = function(a, b) {
        if (!Tc.test(this.P)) throw "Invalid cookie name";
        if (!Sc.test(a)) throw "Invalid cookie value";
        var c = this.P + "=" + a;
        this.M && (c += ";domain=" + this.M);
        this.R && (c += ";path=" + this.R);
        var d = "number" === typeof b ? b : this.Z;
        if (0 <= d) {
            var e = new Date;
    ...
    Z.prototype.U = function() {
        this.F || (this.o = 0, this.F = !0, this.S())
    };
    Z.prototype.S = function() {
        this.F && (this.L() ? this.o = this.H : this.o = Math.min(2 * (this.o || this.H), 120), window.setTimeout(ca(this.S, this), 1E3 * this.o))
    };
    ...
    var ed = null,
        ...
        rb = function() {
            H.oa = !0;
            var a = cd();
            (a = a && a.B) && hb("googleapis.config/sessionIndex", a);
...
gapi.load("plusone", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.tr.66RhiDybnfQ.O/m\u003d__features__/am\u003dEQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAGLTcCP44aB5zxT_438Fjhkhv_jFTcWbeA",
            "u": "https://apis.google.com/js/plusone.js",
            "hee": true,
            "fp": "9385988749fd30977b375e1858653b9f24baeea1",
            "dpo": false
        },
        "platform": ["additnow", "backdrop", "blogger", "comments", "commentcount", "community", "follow", "page", "person", "playreview", "plus", "plusone", "post", "reportabuse", "savetodrive", "savetowallet", "shortlists", "signin2", "udc_webconsentflow", "visibility", "youtube", "ytsubscribe", "zoomableimage", "photocomments", "hangout", "sharetoclassroom"],
        "fp": "9385988749fd30977b375e1858653b9f24baeea1",
