    ...
    var SP_BANK = {
        ...
        GetCommunitiesByTitle: function (userId, callback, callback_err) {
            try {
                $.ajax({
                    type: "GET",
                    url: GLOBALS.ServiceParameter + "/communities/userCommunities/" + userId + "?sortType=SORT_BY_TITLE",
                    contentType: "application/json; charset=utf-8",
                    success: function (msg) {
                        if (msg == null) {
                            if (typeof callback == 'function') {
        ...
        GetCommunitiesByCreationDate: function (userId, callback, callback_err) {
            try {
                $.ajax({
                    type: "GET",
                    url: GLOBALS.ServiceParameter + "/communities/userCommunities/" + userId + "?sortType=SORT_BY_CREATION_DATE",
                    contentType: "application/json; charset=utf-8",
                    success: function (msg) {
                        if (msg == null) {
                            if (typeof callback == 'function') {
        ...
        GetCommunitiesByMemberCount: function (userId, callback, callback_err) {
            try {
                $.ajax({
                    type: "GET",
                    url: GLOBALS.ServiceParameter + "/communities/userCommunities/" + userId + "?sortType=SORT_BY_MEMBER_COUNT",
                    contentType: "application/json; charset=utf-8",
                    success: function (msg) {
                        if (msg == null) {
                            if (typeof callback == 'function') {
